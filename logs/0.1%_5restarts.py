...
if __name__ == "__main__":
    ...
    with open(log_file, 'w', newline='') as csvfile:
        ...
        for compress_config in compress_configs:
            ...
            eta = compress_config.get('eta', '')
            num_steps = compress_config.get('num_steps', '')
            scale = ('_' + str(compress_config["scale"])) if "scale" in compress_config else ""

            name = f'{compression_type}{scale}_{param_usage*100:.1f}%_{lr}{"_EF" if "EF" in compression_type else ""}'
